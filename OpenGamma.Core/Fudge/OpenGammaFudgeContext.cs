...
namespace OpenGamma.Fudge
{
    ...
    public class OpenGammaFudgeContext : FudgeContext
    {
        ...
        {
            var javaMappingStrategy = new OpenGammaTypeMappingStrategy("OpenGamma", "com.opengamma");
        ...
        private static void AddSecondaryTypes(FudgeTypeDictionary typeDictionary)
        {
            ...
            typeDictionary.AddType(new SecondaryFieldType<Tenor, string>(StringFieldType.Instance, Tenor.Create, t => t.ToString()));
        }

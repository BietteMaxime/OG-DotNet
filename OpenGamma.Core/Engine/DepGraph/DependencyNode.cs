...
namespace OpenGamma.Engine.DepGraph
{
    ...
    public class DependencyNode
    {
        ...
        private readonly ComputationTargetSpecification _target;
        private readonly ICollection<DependencyNode> _inputNodes = new List<DependencyNode>();

        public DependencyNode(ComputationTargetSpecification target, IEnumerable<ValueSpecification> inputValues, IEnumerable<ValueSpecification> outputValues, IEnumerable<ValueSpecification> terminalOutputValues, ParameterizedFunction function)
        {
            _target = target;
        ...
        public ComputationTargetSpecification Target
        {
            get { return _target; }
        }

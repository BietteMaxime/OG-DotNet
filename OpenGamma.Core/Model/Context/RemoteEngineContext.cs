...
namespace OpenGamma.Model.Context
{
    public class RemoteEngineContext
    {
        ...
        public RemoteMarketDataSnapshotMaster MarketDataSnapshotMaster
        {
            get
            {
                return new RemoteMarketDataSnapshotMaster(GetTarget("com.opengamma.master.marketdatasnapshot.MarketDataSnapshotMaster", "central"));
            }
        }
        ...
        public RemotePortfolioMaster PortfolioMaster
        {
            get
            {
                ...
                return new RemotePortfolioMaster(GetTarget(componentInfo));
            }
        }
        ...
        public RemoteConfigSource ConfigSource
        {
            get
            {
                var componentInfo = _repository.GetComponentInfo(new ComponentKey("com.opengamma.core.config.ConfigSource", "combined"));
                return new RemoteConfigSource(GetTarget(componentInfo), FudgeContext);
            }
        }
        ...
        public RemoteConfigMaster ConfigMaster
        {
            get
            {
                var componentInfo = _repository.GetComponentInfo(new ComponentKey("com.opengamma.master.config.ConfigMaster", "central"));
                return new RemoteConfigMaster(GetTarget(componentInfo));
            }
        }
    }
}
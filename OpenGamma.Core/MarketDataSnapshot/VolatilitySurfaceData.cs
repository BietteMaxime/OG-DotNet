...
namespace OpenGamma.MarketDataSnapshot
{
    ...
    public class VolatilitySurfaceData
    {
        ...
        public VolatilitySurfaceData(
            string definitionName, string specificationName, Currency currency, string interpolatorName)
        {
    ...
    public class VolatilitySurfaceData<TX, TY> : VolatilitySurfaceData
    {
        ...
        public VolatilitySurfaceData(
            ...
            IList<TX> xs, 
            IList<TY> ys, 
            Dictionary<Tuple<TX, TY>, double> values)
    ...
    public static class VolatilitySurfaceDataExtensions
    {
        ...
        {
            return new InterpolatedDoublesCurve(
                string.Format("Expiry {0}", x), 

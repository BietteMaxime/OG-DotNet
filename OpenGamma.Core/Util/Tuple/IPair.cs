// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IPair.cs" company="OpenGamma Inc. and the OpenGamma group of companies">
...
namespace OpenGamma.Util.Tuple
{
    ...
    public class ObjectsPairBuilder : BuilderBase<Pair>
    {
        ...
        protected override Pair DeserializeImpl(IFudgeFieldContainer msg, IFudgeDeserializer deserializer)
        {

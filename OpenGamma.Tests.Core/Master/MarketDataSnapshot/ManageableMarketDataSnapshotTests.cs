...
namespace OpenGamma.Master.MarketDataSnapshot
{
    public class ManageableMarketDataSnapshotTests
    {
        ...
        {
            var manageableUnstructuredMarketDataSnapshot =
            ...
            var manageableMarketDataSnapshot = new ManageableMarketDataSnapshot(
                ...
                manageableYieldCurveSnapshots, 
                manageableVolatilityCubeSnapshots, 
                manageableVolatilitySurfaceSnapshots);

            var marketDataSnapshot = manageableMarketDataSnapshot.Substract(manageableMarketDataSnapshot);
            var valueSnapshot =
                marketDataSnapshot.YieldCurves.Values.Single().Values.Values.Single().Value.Single().Value;
        ...
        [Fact]
        public void VersionedSecuritiesUpdateCorrectlyBasic()
        {
            // LAP-30
            var before =
                new ManageableUnstructuredMarketDataSnapshot(

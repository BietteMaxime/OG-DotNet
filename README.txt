...
OGDotNet.Tests.Integration - The integration tests for OGDotNet.  These tests should be run against an OpenGamma server.  They may require specific configuration of that server in order to pass.  These also provide simple code snippets for using OGDotNet in meaningful ways.

...
using OpenGamma.Analytics.Math.Matrix;
...
using OpenGamma.Financial.Analytics.Volatility.Cube.Fitting;
using OpenGamma.Financial.Analytics.Volatility.FittedResults;
using OpenGamma.Financial.Analytics.Volatility.Surface;
using OpenGamma.Financial.Analytics.Volatility.Surface.Fitting;
using OpenGamma.Financial.Forex.Method;
using OpenGamma.Financial.Greeks;
using OpenGamma.Financial.InterestRate;
using OpenGamma.Fudge;
using OpenGamma.Id;
using OpenGamma.MarketDataSnapshot;
using OpenGamma.Time.Calendar;
using OpenGamma.Util;
using OpenGamma.Util.Money;
using OpenGamma.Util.Time;
using OpenGamma.Util.TimeSeries.Fast.LongInt;
...
namespace OpenGamma
{
    static class ValueAssertions
    {
        ...
        public static void AssertSensibleValue(IPortfolioNode node)
        {
            Assert.NotNull(node);
            ...
            AssertSensibleValue(node.ChildNodes);
        }

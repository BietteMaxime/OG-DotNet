...
namespace OGDotNet.Mappedtypes.Financial.Analytics.Volatility.Cube.Fitting
{
    /// <summary>
    /// TODO: this
    /// </summary>
    public class FittedSmileDataPoints
    {
        ...
        public FittedSmileDataPoints(Dictionary<Pair<Tenor, Tenor>, ExternalId[]> externalIds, Dictionary<Pair<Tenor, Tenor>, double[]> relativeStrikes)
        {

...
namespace OGDotNet.Tests.Integration.OGDotNet.Resources
{
    public class RemoteManagableViewDefinitionRepositoryTests : TestWithContextBase
    {
        ...
        {
            return new ValueRequirement("Market_Value", new ComputationTargetSpecification(ComputationTargetType.Primitive, UniqueId.Create("BLOOMBERG_TICKER", "BP/ LN Equity")));
        }
    }
}
